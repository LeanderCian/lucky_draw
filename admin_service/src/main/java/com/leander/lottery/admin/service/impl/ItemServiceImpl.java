...
public class ItemServiceImpl implements ItemService {
    ...
    private void syncItemToRedis(Item item) {
        ...
        script.setScriptSource(new ResourceScriptSource(new ClassPathResource("lua/sync_item.lua")));
    ...
    private void syncItemStockToRedis(Item item, Long incrementAmount) {
        ...
        script.setScriptSource(new ResourceScriptSource(new ClassPathResource("lua/sync_item_stock.lua")));
