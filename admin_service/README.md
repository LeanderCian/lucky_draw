...
1. 管理活動
   ...
   2. 修改活動
      ...
      5. response :
         ...
         5. max_tries <0 : Http code 400
         6. end_time before start_time : Http code 400
...
2. 管理獎品
   1. 建立獎品
      ...
      4. required parameters :
         ...
         3. status (int)
            1. 0 - inactive
            2. 1 - active
         4. probability (int) - with micro, ex: 1,000,000 means 1%
         5. total_stock (long)
      5. response :
   ...
   2. 修改獎品
      ...
      5. response :
         ...
         7. probability <= 0% : Http code 400
         8. probability over 100% : Http code 422
         9. non-existent item id : Http code 404
   3. 補充庫存
      1. endpoint : /api/v1/admin/item/{item_id}
      2. method : PATCH
      3. header : Authorization (string, required)
