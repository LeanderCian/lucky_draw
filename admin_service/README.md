...
1. 管理活動
   ...
   2. 修改活動
      ...
      5. response :
         ...
         2. no any parameter : Http code 400
         3. status not defined : Http code 400
         4. max_tries <0 : Http code 400
         5. end_time before start_time : Http code 400
         6. non-existent token or token out of date : Http code 401
   ...
   3. 查詢活動
      ...
      3. header : Authorization (string, required)
      4response :
         1. get campaign success : Http code 200 & return {"id":{campaign_id}, "name":"{name}, "status":{status}, "max_tries":{max_tries}, "start_time":{start_time}, "end_time":{end_time}}
         2. non-existent token or token out of date : Http code 401
         3. not admin token : Http code 403
         4. non-existent campaign id : Http code 404
   4. 設定使用者抽獎次數
      ...
      5. response :
         ...
         2. missing required parameter : Http code 400
...
2. 管理獎品
   1. 建立獎品
      1. endpoint : /api/v1/admin/campaign/{campaign_id}/item
      2. method : POST
      3. header : Authorization (string, required)
      4. required parameters :
         1. name (string)
      ...
      5. response :
         ...
         6. missing required parameters : Http code 400
   ...
   2. 修改獎品
      ...
      5. response :
         ...
         4. status not defined : Http code 400
         5. not admin token : Http code 403
   ...
   3. 補充庫存
      ...
      5. response :
         ...
         3. missing required parameters : Http code 400
         4. non-existent token or token out of date : Http code 401
         5. not admin token : Http code 403
   ...
   4. 查詢獎品
      ...
      3. header : Authorization (string, required)
      4. response :
         1. get item success : Http code 200 & return {"id":{item_id}, "name":"{name}, "status":{status}, "probability":{probability}, "total_stock":{total_stock}, "current_stock":{current_stock}}
         2. non-existent token or token out of date : Http code 401
         3. not admin token : Http code 403
         4. non-existent item id : Http code 404
